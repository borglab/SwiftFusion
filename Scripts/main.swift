...
struct Scripts: ParsableCommand {
  static var configuration = CommandConfiguration(
    subcommands: [Andrew01.self, Andrew02.self, Andrew03.self, Fan01.self, Fan02.self, Fan03.self, Fan04.self, Fan05.self, Fan10.self, Fan12.self, Fan13.self, Fan14.self,
