...
public struct OrientedBoundingBox: Differentiable {
  ...
  public var corners: [Vector2] {
    ...
    func corner(_ uFlip: Double, _ vFlip: Double) -> Vector2 {
      return center.t + center.rot * (0.5 * Vector2(uFlip * size.y, vFlip * size.x))
    }
