...
final class LinearAlgebraTests: XCTestCase {
  ...
  func testVectorAddDerivative() {
    ...
    XCTAssertEqual(value, Vector(4, 6))
    XCTAssertEqual(pb(Vector(1, 0)).0, Vector(1, 0))
    XCTAssertEqual(pb(Vector(1, 0)).1, Vector(1, 0))
    
    XCTAssertEqual(pb(Vector(0, 1)).0, Vector(0, 1))
    XCTAssertEqual(pb(Vector(0, 1)).1, Vector(0, 1))
  }
  ...
  func testVectorScaleDerivative() {
    ...
    XCTAssertEqual(value, Vector(30, 40))
    XCTAssertEqual(pb(Vector(1, 0)).0, 3)
    XCTAssertEqual(pb(Vector(1, 0)).1, Vector(10, 0))
    
    XCTAssertEqual(pb(Vector(0, 1)).0, 4)
    XCTAssertEqual(pb(Vector(0, 1)).1, Vector(0, 10))
  }
